      ...
      <div className="container mx-auto px-4 sm:px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm rounded-full px-4 sm:px-5 py-1.5 sm:py-2 mb-4 sm:mb-6">
            ...
            <span className="text-white/90 text-xs sm:text-sm font-medium tracking-wide uppercase">Para Proprietários</span>
          </div>
          
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-[44px] font-bold text-white mb-4 sm:mb-5">
