  ...
  return (
    <section className="py-16 sm:py-20 md:py-28 bg-gradient-brand relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 text-center relative z-10">
        <p className="text-[11px] sm:text-[13px] uppercase tracking-[0.2em] sm:tracking-[0.25em] text-primary-foreground/40 mb-4 sm:mb-6">{settings.cta_label}</p>
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-[44px] font-semibold text-primary-foreground mb-4 sm:mb-6 leading-tight whitespace-pre-line">
          {settings.cta_title}
        </h2>
        ...
        <a href={whatsappUrl} target="_blank" rel="noopener noreferrer">
          <Button size="lg" className="gap-2 rounded-full px-8">
            {settings.cta_button} <ArrowRight size={16} />
          </Button>
        </a>
      </div>
    </section>
